...
#[derive(Debug, Clone, PartialEq, Eq, Deserialize)]
pub(crate) struct RpcAccountValue {
...
pub(crate) struct FetchedAccounts {
    pub slot: u64,
...
pub(crate) struct LookupTableCacheSnapshot {
    pub revision: u64,
...
#[derive(Debug, Clone)]
pub(crate) struct LookupTableCacheHandle {
...
#[derive(Clone)]
pub(crate) struct GetMultipleAccountsBatcher {
...
pub(crate) fn decode_lookup_table(
    account_key: &str,
